...
class TestClient(object):
  ...
  def test_bad_request(self):
    ...
    responses.add(responses.POST, 'https://api.cai.tool.sap/v2/request', body=body, status=400)
    responses.add(responses.POST, 'https://api.cai.tool.sap/v2/converse', body=body, status=400)
  ...
  def test_text_converse(self):
    ...
    responses.add(responses.POST, 'https://api.cai.tool.sap/v2/converse', body=body, status=200)
